...
const LoginPage = () => {
    ...
    const loginUser = async () => {
        try {
            ...
            let response = await axios.post('http://localhost:3002/api/routes/user/login', formData);
            ...
            <div className='w-full max-w-4xl flex rounded-2xl shadow-xl bg-white overflow-hidden'>
                ...
                <div className='hidden md:block w-1/2 relative bg-gradient-to-br from-blue-400 to-indigo-500'>
                    ...
                    <div className='absolute inset-0 flex items-center justify-center'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" width="2000px" height="1600px" viewBox="0 0 2000 1600" enable-background="new 0 0 2000 1600">
                            <path fill="#FFFFFF" stroke="#000000" stroke-width="5" d="M992.408,521.738c0,65.648-53.218,118.866-118.865,118.866 s-118.866-53.219-118.866-118.866s53.219-118.866,118.866-118.866S992.408,456.091,992.408,521.738z" />
                            ...
                            <path fill="#FFFFFF" stroke="#000000" stroke-width="5" d="M420.417,347.077c0,65.648-53.218,118.866-118.866,118.866 s-118.866-53.219-118.866-118.866c0-65.647,53.218-118.866,118.866-118.866S420.417,281.43,420.417,347.077z" />
                            ...
                            <path fill="#FFFFFF" stroke="#000000" stroke-width="5" d="M500.783,1177.664c0,65.648-53.219,118.865-118.866,118.865 s-118.866-53.218-118.866-118.865s53.219-118.866,118.866-118.866S500.783,1112.016,500.783,1177.664z" />
                            ...
                            <path fill="#FFFFFF" stroke="#000000" stroke-width="5" d="M1536.279,655.041c0,65.648-53.218,118.865-118.865,118.865 s-118.866-53.218-118.866-118.865s53.219-118.866,118.866-118.866S1536.279,589.393,1536.279,655.041z" />
                            ...
                            <path fill="#FFFFFF" stroke="#CC0033" stroke-width="5" d="M1126.218,1043.975c0,65.648-53.218,118.866-118.865,118.866 s-118.866-53.219-118.866-118.866s53.219-118.866,118.866-118.866S1126.218,978.328,1126.218,1043.975z" />
                            <path fill="#FF5500" d="M1007.456,962.032" />
                            <g>
                                <path fill="#CC0000" d="M1004.107,972.611c9.378,0,16.981-7.604,16.981-16.983c0-9.382-7.604-16.985-16.981-16.985 c-9.38,0-16.985,7.606-16.985,16.985C987.122,965.008,994.725,972.611,1004.107,972.611z" />
                                <path fill="#E3001C" d="M985.93,976.359c-12.028,0-21.7,9.81-21.7,22.045v52.149c0,10.139,14.837,10.139,14.837,0v-47.683h3.512 v130.565c0,13.557,19.759,13.155,19.759,0v-75.792h3.402v75.792c0,13.155,19.864,13.557,19.864,0v-130.565h3.431v47.683 c0,10.217,14.762,10.217,14.735,0v-51.832c0-11.283-8.761-22.333-21.967-22.333l-35.874-0.023V976.359z" />
                            </g>
                            <path fill="#FFFFFF" stroke="#000000" stroke-width="5" d="M1691.271,1285.357c0,65.648-53.219,118.865-118.866,118.865 s-118.865-53.219-118.865-118.865c0-65.647,53.218-118.866,118.865-118.866S1691.271,1219.71,1691.271,1285.357z" />
                            ...
                            <path fill="#FFFFFF" stroke="#000000" stroke-width="5" d="M1801.344,308.736c0,65.649-53.219,118.866-118.866,118.866 s-118.865-53.219-118.865-118.866c0-65.647,53.218-118.865,118.865-118.865S1801.344,243.089,1801.344,308.736z" />
                            ...
                            <path fill="none" stroke="#000000" stroke-width="5" stroke-linecap="round" d="M430.423,384.087l317.511,92.374" />
                            <path fill="none" stroke="#000000" stroke-width="5" stroke-linecap="round" d="M1000.8,561.521l283.596,66.144" />
                            <path fill="none" stroke="#000000" stroke-width="5" stroke-linecap="round" d="M1497.321,549.634l105.731-134.345" />
                            <path fill="none" stroke="#000000" stroke-width="5" stroke-linecap="round" d="M896.9,652.7l76.767,261.782" />
                            <path fill="#FF5500" stroke="#000000" stroke-width="5" stroke-linecap="round" d="M1329.285,755.499l-215.654,209.469" />
                            <path fill="none" stroke="#000000" stroke-width="5" stroke-linecap="round" d="M513.613,1150.848l363.396-81.184" />
                            <path fill="none" stroke="#000000" stroke-width="5" stroke-linecap="round" d="M1116.697,1120.469l326.401,132.547" />
                            <path fill="none" stroke="#000000" stroke-width="5" stroke-linecap="round" d="M890.552,982.019L371.614,461.427" />
                            <path fill="none" stroke="#000000" stroke-width="5" stroke-linecap="round" d="M769.263,602.001l-325.809,456.835" />
                            <path fill="none" stroke="#000000" stroke-width="5" stroke-linecap="round" d="M996.605,468.057L1549.58,327.47" />
                            <path fill="none" stroke="#000000" stroke-width="5" stroke-linecap="round" d="M1669.189,444.146l-72.771,709.875" />
                            <path fill="none" stroke="#000000" stroke-width="5" stroke-linecap="round" d="M1457.917,780.445l65.797,380.557" />
                    ...
                    <div className='absolute bottom-8 left-8 right-8 text-white'>
                        ...
                        <p className='text-white/80'>Access your account with our secure login system</p>
                    </div>
                </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className='space-y-8'>
                                ...
                                <div className='space-y-2'>
                                    ...
                                    <div className='relative group'>
                                        ...
                                        <input
                                            ...
                                            className='w-full px-10 py-3 rounded-lg border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all duration-200'
                                        />{
                                            view ? <Eye onClick={viewPass} className='cursor-pointer absolute right-2 top-1/2  -translate-y-1/2 text-gray-400 w-5 h-5 group-hover:text-blue-500 transition-colors duration-200' />
                                                : <EyeOff onClick={viewPass} className='cursor-pointer absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5 group-hover:text-blue-500 transition-colors duration-200' />
                                        }
                            ...
                            <div className='space-y-4'>
                                <button
                                    className='w-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white py-3 rounded-lg font-medium shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200'
