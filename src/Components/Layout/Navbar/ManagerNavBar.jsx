...
const navItems = [
    ...
    { 
        ...
        label: 'Attendance',
        icon: Clock,
        path: '/manager/attendence-history'
    ...
    { 
        ...
        path: '/manager/view-records'
    },
    { id: 'profile', label: 'Profile', icon: UserCircle, path:"/manager/profile" },
    // { id: 'logout', label: 'Logout', icon: LogOut }
];

const ManagerNavBar = ({ onNavigate = () => {} }) => {
            ...
            <div className="ps-4">
                <button
                    ...
                    className={`flex items-center gap-2 w-full text-left text-lg font-bold py-3 px-4 rounded-lg transition-colors duration-200 ${
                        isActive('/manager/dashboard') ? activeClasses : inactiveClasses
                    }`}
                >
